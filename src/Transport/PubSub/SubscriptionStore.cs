namespace NServiceBus.Transport.AzureStorageQueues
{
    ...
    class SubscriptionStore : ISubscriptionStore
    {
        ...
        public async Task<IEnumerable<string>> GetSubscribers(Type eventType)
        {
            ...
            {
                retrieveTasks.Add(Retrieve(topic, table));
            }
        ...
        static async Task<IEnumerable<SubscriptionEntity>> Retrieve(string topic, CloudTable table)
        {
            ...
            return await table.QueryAll(query).ConfigureAwait(false);
        }
