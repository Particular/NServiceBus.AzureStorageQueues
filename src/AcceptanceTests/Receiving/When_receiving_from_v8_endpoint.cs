        ...
        class Receiver : EndpointConfigurationBuilder
        {
            public Receiver()
            {
                EndpointSetup<DefaultServer>(config =>
                {
                    ...
                    {
                        var wrapper = JsonConvert.DeserializeObject<MessageWrapper>(message.MessageText);
                        return wrapper;
                    });
                });
            }
